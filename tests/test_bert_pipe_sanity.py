...
if __name__ == "__main__":
    model_dir = os.path.join(base_dir, "bert-base-uncased")
    ...
    model_gold = BertForQuestionAnswering.from_pretrained(model_dir)
    ...
    model_test = BertPyTorchPipeForQuestionAnswering(model_gold)
    ...
    outputs_test = model_test((input_ids, token_type_ids, attention_mask), output_hidden_states=True)
